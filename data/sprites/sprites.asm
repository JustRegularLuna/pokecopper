...
; entries correspond to SPRITE_* constants
	overworld_sprite HiroSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
	overworld_sprite HiroBikeSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
	overworld_sprite SylviaSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
	overworld_sprite SylviaBikeSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
