...
Sfx_Unknown5F_Ch8:
	...
	noise_note 3, 5, -1, 22
	noise_note 2, 0, 0, 0
	sound_loop 3, Sfx_Unknown5F_Ch8
	sound_ret
...
.branch_f1cb9:
	...
	sound_loop 2, .branch_f1cb9
	pitch_sweep 0, 8
	sound_ret


SECTION "Sfx_IntroWhoosh", ROMX
