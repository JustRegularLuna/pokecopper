...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_SAKURA
	const PREDEFPAL_BELLFLOWER
	const PREDEFPAL_CYPRESS
	const PREDEFPAL_BEGONIA
	const PREDEFPAL_MARIGOLD
	const PREDEFPAL_MAPLE
	const PREDEFPAL_AZURE_MIST
	const PREDEFPAL_CEDAR
	const PREDEFPAL_EBONGROVE
	const PREDEFPAL_WISTERIA
	const PREDEFPAL_SILVER
	const PREDEFPAL_DUNGEONS
	const PREDEFPAL_NITE
	const PREDEFPAL_BLACKOUT
	const PREDEFPAL_MEWMON
	const PREDEFPAL_BLUEMON
	const PREDEFPAL_REDMON
	const PREDEFPAL_CYANMON
	const PREDEFPAL_PURPLEMON
	const PREDEFPAL_BROWNMON
	const PREDEFPAL_GREENMON
	const PREDEFPAL_PINKMON
	const PREDEFPAL_YELLOWMON
	const PREDEFPAL_GREYMON
	const PREDEFPAL_SHINY_MEWMON
	const PREDEFPAL_SHINY_BLUEMON
	const PREDEFPAL_SHINY_REDMON
	const PREDEFPAL_SHINY_CYANMON
	const PREDEFPAL_SHINY_PURPLEMON
	const PREDEFPAL_SHINY_BROWNMON
	const PREDEFPAL_SHINY_GREENMON
	const PREDEFPAL_SHINY_PINKMON
	const PREDEFPAL_SHINY_YELLOWMON
	const PREDEFPAL_SHINY_GREYMON
